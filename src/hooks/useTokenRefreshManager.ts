...
//   import.meta.env.VITE_REFRESH_INTERVAL || 15 * 60 * 1000; // Default to 15 minutes
// const MAX_RETRY_ATTEMPTS = import.meta.env.VITE_MAX_RETRY_ATTEMPTS || 3;
// const RETRY_DELAY = import.meta.env.VITE_RETRY_DELAY || 5000; // 5 seconds
